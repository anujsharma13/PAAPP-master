...
public class UpdateAdm extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_update_adm);


        b1=findViewById(R.id.btnApproveadm);
        b2=findViewById(R.id.btnRejectadm);

        Random random=new Random();
        progressBar=findViewById(R.id.progressbaradm1);
        progressBar1=findViewById(R.id.progressbaradm2);
        ...
        b1.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                ...
                String messageToSend = "------------------Your Appointment with ADM is Booked Successfully please refer to the mail below " +
                        "------------------" +
                        "\n\n" +"Your Appointment Number is "+ra+"\n\n"
                        +"Given Information :: " + "\n\n" + "Given Information :: " + "\n\n" + "Name : " + name + "\n\n" + "Mobile No. : " + mobileno + "\n\n" +
                        "Date of Appointment : " + date + "\n\n" + "Time of Appointment : "
                        + time + "\n\n" + "Email : " + stremail + "\n\n" + "Reason To Meet ADM : " + strreview + "\n\n" + "No. of Visitors : " + strvisitor
                        + "\n\n" + "Note :  Your Appointment Request is completed Successfully." +
                        " The Confirmation Email  has an Appointment number inside it , You have to provide your appointment number before meeting ADM" +
                ...
                try {
                    ...
                    AlertDialog.Builder builder1 = new AlertDialog.Builder(UpdateAdm.this);
                    ...
                    builder1.setPositiveButton(
                            ...
                            new DialogInterface.OnClickListener() {
                                public void onClick(DialogInterface dialog, int id) {
                                    startActivity(new Intent(UpdateAdm.this, ADM.class));
                                }
                            });
                ...
                String messageToSend1 = "------------------Your Appointment with ADM is Booked Successfully please refer to the mail below " +
                        "------------------" +
                        "\n\n" +"Your Appointment Number is "+ra+"\n\n"
                        +"Given Information :: " + "\n\n"+ "Given Information :: " + "\n\n" + "Name : " + name + "\n\n" + "Mobile No. : " + mobileno + "\n\n" +
                        "Date of Appointment : " + date + "\n\n" + "Time of Appointment : "
                ...
                Query applesQuery = ref.child("ADM").orderByChild("mobileno").equalTo(mobileno);
        ...
        b2.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                ...
                String messageToSend ="------------------Your Appointment with ADM is Rejected" +
                        "------------------" +
                        "\n\n" + "PLEASE CHOOSE DIFFERENT DATE TO BOOK APPOINTMENT WITH ADM" +"\n\n"+ "Given Information :: " + "\n\n" + "Name : " + name + "\n\n" + "Mobile No. : " + mobileno + "\n\n" +
                        "Date of Appointment : " + date + "\n\n" + "Time of Appointment : "
                        + time + "\n\n" + "Email : " + stremail + "\n\n" + "Reason To Meet ADM : " + strreview + "\n\n" + "No. of Visitors : " + strvisitor
                        + "\n\n" + "Note :  Your Appointment Request is Rejected as ADM is having busy schedule." +"\n\n"+
                ...
                try {
                    ...
                    builder1.setPositiveButton(
                            ...
                            new DialogInterface.OnClickListener() {
                                public void onClick(DialogInterface dialog, int id) {
                                    startActivity(new Intent(UpdateAdm.this, DM.class));
                                }
                            });
                ...
                String messageToSend1 = "------------------Your Appointment with ADM is Rejected" +
                        "------------------" +
                        "\n\n" + "PLEASE CHOOSE DIFFERENT DATE TO BOOK APPOINTMENT WITH ADM" +"\n\n"+ "Given Information :: " + "\n\n" + "Name : " + name + "\n\n" + "Mobile No. : " + mobileno + "\n\n" +
                        "Date of Appointment : " + date + "\n\n" + "Time of Appointment : "
                        + time + "\n\n" + "Email : " + stremail + "\n\n" + "Reason To Meet ADM : " + strreview + "\n\n" + "No. of Visitors : " + strvisitor
