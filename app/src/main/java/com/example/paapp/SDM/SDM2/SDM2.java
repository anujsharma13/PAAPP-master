...
public class SDM2 extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_s_d_m2);


        List<User> userList = new ArrayList<>();


        listView = (ListView) findViewById(R.id.listviewtxtsdm2);
...
//            btnDelete=findViewById(R.id.btnDelete);
        ...
        reference = FirebaseDatabase.getInstance().getReference("users").child("SDM").child("SDM2");
        ;
        reference.addValueEventListener(new ValueEventListener() {
            ...
            public void onDataChange(@NonNull DataSnapshot dataSnapshot) {
                ...
                adapter = new ListAdapterClass1(SDM2.this, list);
        ...
        listView.setOnItemClickListener(new AdapterView.OnItemClickListener() {
            ...
            public void onItemClick(AdapterView<?> parent, View view, int position, long id) {
                ...
                Toast.makeText(SDM2.this, list.get(position).getName(), Toast.LENGTH_SHORT).show();

                Intent intent=new Intent(getApplicationContext(),UpdateSdm2.class);
