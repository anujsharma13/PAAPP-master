...
public class SDM1 extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_s_d_m1);
...
//            btnDelete=findViewById(R.id.btnDelete);
        ...
        reference = FirebaseDatabase.getInstance().getReference("users").child("SDM").child("SDM1");;
            reference.addValueEventListener(new ValueEventListener() {
                ...
                public void onDataChange(@NonNull DataSnapshot dataSnapshot) {
                    ...
                    adapter = new ListAdapterClass1(SDM1.this,list);
                ...
                public void onCancelled(@NonNull DatabaseError databaseError) {
                    Toast.makeText(SDM1.this, "Opsss.... Something is wrong", Toast.LENGTH_SHORT).show();
                }
            });
            ...
            listView.setOnItemClickListener(new AdapterView.OnItemClickListener() {
                ...
                public void onItemClick(AdapterView<?> parent, View view, int position, long id) {
                    ...
                    Toast.makeText(SDM1.this, list.get(position).getName(), Toast.LENGTH_SHORT).show();

                    Intent intent=new Intent(getApplicationContext(),UpdateClassSdm1.class);
