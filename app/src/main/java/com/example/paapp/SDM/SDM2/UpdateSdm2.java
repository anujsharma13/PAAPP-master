package com.example.paapp.SDM.SDM2;
...
public class UpdateSdm2 extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_update_sdm2);


        b1=findViewById(R.id.btnApprovesdm2);
        b2=findViewById(R.id.btnRejectsdm2);
        ...
        b1.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                b1.setText("Please Wait while we process");
                ...
                String messageToSend = "------------------Your Appointment with SDM Defence Colony is Booked Successfully please refer to the mail below " +
                        "------------------" +
                        ...
                        " The Confirmation Email  has an Appointment number inside it , You have to provide your appointment number before meeting SDM DEFENCE COLONY." +
                ...
                try {
                    ...
                    AlertDialog.Builder builder1 = new AlertDialog.Builder(UpdateSdm2.this);
                    ...
                    builder1.setPositiveButton(
                            ...
                            new DialogInterface.OnClickListener() {
                                public void onClick(DialogInterface dialog, int id) {
                                    startActivity(new Intent(UpdateSdm2.this, SDM2.class));
                                }
                            });
                ...
                String messageToSend1 = "------------------Your Appointment with SDM Defence Colony is Booked Successfully please refer to the mail below " +
                        "------------------" +
                        "\n\n" +"Your Appointment Number is "+ra+"\n\n"
                        +"Given Information :: " + "\n\n"+ "Given Information :: " + "\n\n" + "Name : " + name + "\n\n" + "Mobile No. : " + mobileno + "\n\n" +
                        "Date of Appointment : " + date + "\n\n" + "Time of Appointment : "
                ...
                Query applesQuery = ref.child("SDM2").orderByChild("mobileno").equalTo(mobileno);
        ...
        b2.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                ...
                String messageToSend ="------------------Your Appointment with SDM KALKA Ji is Rejected" +
                        "------------------" +
                        "\n\n" + "PLEASE CHOOSE DIFFERENT DATE TO BOOK APPOINTMENT WITH SDM DEFENCE COLONY" +"\n\n"+ "Given Information :: " + "\n\n" + "Name : " + name + "\n\n" + "Mobile No. : " + mobileno + "\n\n" +
                        "Date of Appointment : " + date + "\n\n" + "Time of Appointment : "
                        + time + "\n\n" + "Email : " + stremail + "\n\n" + "Reason To Meet SDM : " + strreview + "\n\n" + "No. of Visitors : " + strvisitor
