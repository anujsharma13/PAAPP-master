...
public class DM extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        listView= (ListView) findViewById(R.id.listviewtxtdm);
...
//            btnDelete=findViewById(R.id.btnDelete);
        ...
        reference = FirebaseDatabase.getInstance().getReference("users").child("DM");
        reference.addValueEventListener(new ValueEventListener() {
            ...
            public void onDataChange(@NonNull DataSnapshot dataSnapshot) {
                ...
                adapter = new ListAdapterClass1(DM.this,list);
            ...
            public void onCancelled(@NonNull DatabaseError databaseError) {
                Toast.makeText(DM.this, "Opsss.... Something is wrong", Toast.LENGTH_SHORT).show();
            }
        });
        ...
        listView.setOnItemClickListener(new AdapterView.OnItemClickListener() {
            ...
            public void onItemClick(AdapterView<?> parent, View view, int position, long id) {
                ...
                Toast.makeText(DM.this, list.get(position).getName(), Toast.LENGTH_SHORT).show();

                Intent intent=new Intent(getApplicationContext(),UpdateDM.class);
